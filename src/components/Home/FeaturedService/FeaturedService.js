...
import featured from '../../../images/about-image.jpg';
            ...
            <div className="container mb-5">
                <div className="row mb-5">
                    <div className="col-md-5 mb-4 m-md-0">
                        <img style={{ borderRadius: '30%' }} className="img-fluid" src={featured} alt="" />
                    </div>
                    <div className="col-md-7 align-self-center">
                        <h1 style={{ textAlign: 'justify' }}>Successfully Providing the Best Computer and Mobile Services for <span className="text-success">20</span> years</h1>
                        <p style={{ textAlign: 'justify' }} className="text-secondary my-5">
